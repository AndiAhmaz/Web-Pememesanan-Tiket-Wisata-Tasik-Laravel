																																...
																																<form action="/orders" method="POST">
																																				...
																																				<div class="card-body">
																																								...
																																								<div class="form-group row">
																																												<label for="inputEmail3" class="col-sm-2 col-form-label">Penginapan :</label>
																																												<div class="col-sm-5">
																																								...
																																								<div class="form-group row">
																																												<label for="airline_id" class="col-sm-2 col-form-label">Nama Wisata :</label>
																																												<div class="col-sm-5">
																																												...
																																												<div class="col-sm-5">
																																																<div class="form-group">
																																																				<select name="type_id" class="form-control" id="airline_class" required>
																																																								...
																																																								@else
																																																												<option selected value="">-- Pilih Jenis Wisata --
																																																												</option>
																																																								@endif
																																																				...
																																																				@if ($errors->has('airline_id'))
																																																								<div class="invalid-feedback">
																																																												Pilih jenis Wisata dengan benar!
																																																								</div>
																																																				@endif
																																																</div>
																																												</div>
																																																...
																																																<div class="form-group">
																																																				<div class="form-check">
																																																								<input class="form-check-input" id="pergi-check" type="radio"
																																																												...
																																																												checked @endif
																																																												value="false">
																																																								<label class="form-check-label">Anak - anak</label>
																																																				</div>
																																																</div>
																																												</div>
																																								...
																																								<h4>Data Wisatawan :</h4>

																																								<div class="form-group row" id="penumpang-1">
																																												<label for="inputEmail3" class="col-sm-2 col-form-label">Orang 1:</label>
																																												<div class="col-sm-2">
																																																<div class="form-group">
																																																				<input type="text"
																																								...
																																								<div class="form-group row" id="penumpang-2">
																																												<label for="inputEmail3" class="col-sm-2 col-form-label">Orang 2:</label>
																																												<div class="col-sm-2">
																																																<div class="form-group">
																																																				<input type="text" class="form-control" id="inputEmail3"
																																								...
																																								<div class="form-group row" id="penumpang-3">
																																												<label for="inputEmail3" class="col-sm-2 col-form-label">Orang 3:</label>
																																												<div class="col-sm-2">
																																																<div class="form-group">
																																																				<input type="text" class="form-control" id="inputEmail3"
																																								...
																																								<div class="form-group row" id="penumpang-4">
																																												<label for="inputEmail3" class="col-sm-2 col-form-label">Orang 4:</label>
																																												<div class="col-sm-2">
																																																<div class="form-group">
																																																				<input type="text" class="form-control" id="inputEmail3"
																																								...
																																								<div class="form-group row" id="penumpang-5">
																																												<label for="inputEmail3" class="col-sm-2 col-form-label">Orang 5:</label>
																																												<div class="col-sm-2">
																																																<div class="form-group">
																																																				<input type="text" class="form-control" id="inputEmail3"
